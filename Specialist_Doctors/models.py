...
class SpecialistDoctor(models.Model):
    ...
    class Meta:
        verbose_name_plural = "Specialist Doctors"
        db_table = "SpecialistDoctor"


class SpecialistDoctorsAppointment(models.Model):
    patient_name = models.CharField(max_length=120)
    patient_age = models.CharField(max_length=120)
    patient_phone = models.CharField(max_length=120)
    details = models.TextField()
    doctor_id = models.ForeignKey(
        SpecialistDoctor, verbose_name="Doctor", on_delete=models.CASCADE)
